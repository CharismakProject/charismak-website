        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1fr_auto] lg:items-end">
          <div>
            ...
            <h2 className="mt-4 max-w-4xl text-4xl font-semibold leading-tight tracking-[-0.04em] md:text-6xl">
              Let’s build something that works well and lasts.
            </h2>
            <p className="mt-6 max-w-2xl text-base leading-8 text-white/65">
              Construction, renovation, engineering and project management with clear planning, close site supervision and practical attention to cost.
            </p>
          </div>
        ...
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[1.3fr_0.8fr_0.8fr_1fr]">
          ...
          <div>
            ...
            <div className="mt-6 space-y-5 text-sm text-white/58">
              <Link href={`mailto:${email}`} className="flex gap-3 hover:text-white">
