...
export default function DetailedEstimatorPage() {
  return (
    <main className="overflow-hidden bg-[#F7F8FA] pt-20">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-14 lg:grid-cols-[0.88fr_1.12fr] lg:items-center">
          <div>
            <div className="flex flex-wrap items-center gap-3">
              <span className="border border-[#C8A45D]/35 bg-[#C8A45D]/10 px-3 py-2 text-xs font-bold uppercase tracking-[0.2em] text-[#F2B544]">Detailed cost planner</span>
            ...
            <h1 className="mt-7 text-5xl font-semibold leading-[1.02] tracking-[-0.04em] sm:text-6xl lg:text-7xl">
              ...
              <span className="mt-2 block text-[#E8C77F]">construction budget in detail.</span>
            </h1>
            ...
            <div className="mt-9 flex flex-wrap gap-4">
              <a href="#quick-building-cost" className="inline-flex items-center gap-3 bg-[#0D3B66] px-7 py-4 text-sm font-bold text-white transition hover:bg-[#C8A45D] hover:text-[#071E33]">Start detailed estimate <ArrowRight className="h-5 w-5" /></a>
              <Link href="/estimator" className="inline-flex items-center gap-3 border border-white/25 bg-white/5 px-7 py-4 text-sm font-bold text-white transition hover:bg-white hover:text-[#071E33]">Estimator home</Link>
            </div>
          ...
          <div className="border border-white/12 bg-white/[0.055] p-6 shadow-[0_32px_90px_rgba(0,0,0,0.28)] backdrop-blur md:p-8">
            <div className="flex items-center justify-between border-b border-white/12 pb-5">
              <div><p className="text-[10px] font-bold uppercase tracking-[0.22em] text-[#F2B544]">Detailed planning estimate</p><h2 className="mt-2 text-2xl font-semibold">Describe · Refine · Compare · Budget</h2></div>
            ...
            <div className="mt-5 border-l border-[#C8A45D] bg-[#C8A45D]/10 p-4 text-sm leading-6 text-white/72">Use the estimate for feasibility and budget planning. A project-specific commercial figure still requires drawings, measured quantities, specification review and current quotations.</div>
          </div>
        </div>
      </section>
      ...
      <section id="how-it-works" className="px-5 py-20 md:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-4 grid gap-8 lg:grid-cols-[0.62fr_1.38fr] lg:items-end">
            <h2 className="max-w-3xl text-3xl font-semibold leading-tight tracking-[-0.03em] text-[#071E33] md:text-5xl">One detailed public tool for early construction budget decisions.</h2>
      ...
      <section className="bg-[#071E33] px-5 py-16 text-white md:px-8">
        <div className="mx-auto flex max-w-7xl flex-col justify-between gap-8 lg:flex-row lg:items-center">
          ...
          <Link href="/contact" className="inline-flex w-fit items-center gap-3 bg-[#C8A45D] px-8 py-5 font-bold text-[#071E33] transition hover:bg-white">Contact us for a project-specific estimate <ArrowRight className="h-5 w-5" /></Link>
        </div>
      </section>
    </main>
  );
