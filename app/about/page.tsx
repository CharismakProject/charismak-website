...
const principles = [
  ...
  },
  {
    ...
    text: "Clients receive clear updates, practical recommendations and transparent project information throughout delivery.",
    icon: BadgeCheck,
  },
];
        ...
        <div className="relative mx-auto flex min-h-[660px] max-w-7xl items-center px-5 py-20 md:px-8">
          <div className="max-w-4xl">
            ...
            <h1 className="max-w-5xl text-5xl font-semibold leading-[1.02] tracking-[-0.04em] sm:text-6xl lg:text-7xl">
              ...
              <span className="mt-2 block text-[#E8C77F]">Commercial discipline. Reliable delivery.</span>
            </h1>
        ...
        <div className="mx-auto grid max-w-7xl gap-14 lg:grid-cols-[0.86fr_1.14fr] lg:items-center">
          <div>
            ...
            <h2 className="text-3xl font-semibold leading-tight tracking-[-0.03em] text-[#071E33] md:text-5xl">
              Practical construction capability backed by cost and project management experience.
            </h2>
            <p className="mt-6 text-base leading-8 text-[#3A4653]">{company.overview}</p>
            <p className="mt-5 text-base leading-8 text-[#3A4653]">
              Our delivery approach brings construction management, quantity surveying,
              technical supervision, procurement coordination and quality control together
              so projects are managed with a clear view of scope, cost, programme and workmanship.
            </p>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="relative min-h-[540px] overflow-hidden sm:row-span-2">
              <Image src="/Images/Projects/Djibouti/cover.jpg" alt="International construction project experience" fill sizes="(max-width: 1024px) 100vw, 34vw" className="object-cover" />
              ...
              <div className="absolute bottom-0 p-7 text-white">
                ...
                <h3 className="mt-3 max-w-sm text-2xl font-semibold leading-tight">Experience developed through real construction, cost and delivery assignments.</h3>
              </div>
            </div>
            <div className="relative min-h-[260px] overflow-hidden">
              <Image src="/Images/Projects/Flawless/cover.jpg" alt="Renovation and finishing works" fill sizes="(max-width: 640px) 100vw, 25vw" className="object-cover" />
            </div>
            <div className="flex min-h-[260px] flex-col justify-between bg-[#0D3B66] p-7 text-white">
              ...
              <div>
                ...
                <p className="mt-4 text-xl font-semibold leading-8">Construction, renovation, engineering, consultancy, project management and specialist delivery.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-8 lg:grid-cols-[0.58fr_1.42fr] lg:items-end">
            <div>
              ...
              <h2 className="text-3xl font-semibold leading-tight tracking-[-0.03em] text-[#071E33] md:text-5xl">Control where it matters. Flexibility where it helps.</h2>
            </div>
            <p className="max-w-2xl text-base leading-8 text-[#3A4653] lg:justify-self-end">
              We organise projects around clear responsibilities, practical decision-making,
              disciplined supervision and timely communication from mobilisation through handover.
            </p>
          </div>
