...
const routeOptions: Array<{
  ...
  },
  {
    ...
    description: "Describe the building or work dimensions in one guided workspace.",
  ...
  },
  {
    ...
    description: "Start with an AI drawing pre-check, review dimensions, then continue measured work.",
    audiences: ["professional", "company"],
    available: true,
  },
];
